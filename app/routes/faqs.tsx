    ...
    <div className="container mx-auto px-4 py-16">
      <div className="max-w-4xl mx-auto space-y-12">
        ...
        <Card className="border-none shadow-lg">
          <CardHeader>
            <CardTitle className="text-3xl font-bold">Platform FAQs</CardTitle>
          </CardHeader>
          <CardContent className="space-y-6">
            <div id="sp-ea-29573" className="sp-ea-one sp-easy-accordion">
              {[
                {
                  id: 1,
                ...
                <div key={faq.id} className="ea-card sp-ea-single mb-6">
                  <h3 className="ea-header">
                    <a className="collapsed flex items-center justify-between p-4 bg-gray-50 rounded-lg" 
                       data-sptoggle="spcollapse" 
                       data-sptarget={`#${faq.target}`}
                       href="#"
                       aria-expanded="false">
                      <span className="text-lg font-semibold">
                        <i className="ea-expand-icon fa fa-plus mr-3"></i>
                        {faq.question}
                      </span>
                    </a>
                  </h3>
                  <div className="sp-collapse spcollapse" id={faq.target}>
                    <div className="ea-body animated fadeIn p-4 bg-white border border-gray-100 rounded-b-lg">
